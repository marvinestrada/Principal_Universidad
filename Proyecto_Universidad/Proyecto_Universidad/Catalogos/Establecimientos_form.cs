...
{
    public partial class Establecimientos_form : Form
    {
        public int id = 0;
        int Codigo = 0;
        public Establecimientos_form(int codigo = 0, string ciclo = "", string año = "")
        {
            InitializeComponent();
            Codigo = codigo;
            txtciclo.Text = ciclo;
        ...
        {
            Municipio_lista ventana = new Municipio_lista();
            ventana.ShowDialog();
            ventana.Dispose();
        }
    }
